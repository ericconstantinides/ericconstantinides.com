const projects = [
  {
    ...
    title: 'Automation Anywhere Automation 360',
    alt_title: 'Automation 360',
    employer: 'Automation Anywhere',
    date: '2021-Current',
    // website: '',
    active: false,
    role: 'UI Architect',
    description: 'Web-based Automation / Robotic Process Automation (RPA) Platform',
    screenshot: 'portfolio--automation-anywhere-cfc--md.png',
    primary_tech: ['React', 'CSS Modules', 'JS', 'CSS']
  },
  {
    id: 'aa_2019_automationanywhere',
    title: 'Automation Anywhere Developer Portal',
    alt_title: 'Developer Portal',
    employer: 'Automation Anywhere',
    date: '2020',
    website: 'developer.automationanywhere.com',
    active: true,
    role: 'Lead UI / JavaScript / React Engineer',
    description: 'A Next.js "Headless Wordpress" powered site built for speed and usability',
    screenshot: 'portfolio--automation-anywhere-developer-portal--md.png',
    primary_tech: ['Next.js', 'React', 'CSS Modules', 'JS', 'CSS', 'Wordpress']
  },
  {
    id: 'aa_2019_automationanywhere',
    title: 'Automation Anywhere Private Bot Store',
    alt_title: 'Private Bot Store',
    employer: 'Automation Anywhere',
    date: '2019-2020',
    website: 'privatestore.automationanywhere.com',
    active: false,
    role: 'Lead UI / JavaScript / React Engineer',
    description: 'Automation Anywhere\'s B2B RPA Bot Store.',
    screenshot: 'portfolio--automation-anywhere-private-botstore--md.png',
    primary_tech: ['React', 'Webpack', 'CSS Modules', 'Post CSS', 'JS', 'CSS', 'Wordpress']
  },
  {
    id: 'aa_2019_automationanywhere',
    title: 'Automation Anywhere Bot Store',
    alt_title: 'Bot Store',
    employer: 'Automation Anywhere',
    date: '2019-2020',
    ...
    active: true,
    role: 'Lead UI / JavaScript / React Engineer',
    description: 'Automation Anywhere\'s Digital Automation Marketplace.',
